...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Feed Tracker web application."
  #
  #
  ...
  #
  # settings.secret_key_base= KMxnSwD05id0CzcTGwq1YvUD9IzDn1wzGLeo4Gd3LSo
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("feed-tracker.log", "w"))
  #
  #
end
